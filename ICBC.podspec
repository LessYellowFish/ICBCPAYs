...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "LessYellowFish" => "email@address.com" }
  # Or just: spec.author    = "LessYellowFish"
  # spec.authors            = { "LessYellowFish" => "email@address.com" }
  # spec.social_media_url   = "https://twitter.com/LessYellowFish"
